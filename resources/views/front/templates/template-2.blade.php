...
<body>
    <table cellpadding="0" cellspacing="0" width="100%" style="border:1;border-collapse:collapse;border-spacing:0;font-size:20px;color:#333;font-family:Arial, Helvetica, sans-serif">
        <tr>
            <td>
                <h2 style="font-size:28px;color:#007bff;text-align:center;">{{$data['first_name'] }} {{ $data['last_name']}}</h2>
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#007bff">Summary</h2>
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#007bff">Skills</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#007bff">Work History</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#007bff">Education</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#007bff">Reference</h2>
                <div style="padding: 0 20px">
