...
<body>
    <div class="container-fluid">
        <div class="main clearfix">
            <div class="row">
                <section class="col-md-12 card-wrapper profile-card-wrapper affix">
                            ...
                            <div class="name-and-profession text-center">
                                ...
                                <div class="contact-details clearfix">
                                    <div class="detail d-inline-block">
                                        ...
                                        <span class="info"> {{$data['street'] }}, {{ $data['city']}}, {{ $data['country']}}, {{ $data['postal_code']}}</span>
                                    </div>
                                    <div class="detail d-inline-block">
                                        <span class=" icon"><i class="icon fs-lg icon-phone"></i></span>
                                        <span class="info" itemprop="telephone"> {{$data['phone'] }}</span>
                                    </div>
                                    <div class="detail d-inline-block">
                                        <span class=" icon"><i class="icon fs-lg icon-mail"></i></span>
                                        <span class="info"><a class="link-disguise" href="mailto:richard@valley.com" itemprop="email"> {{$data['email'] }}</a></span>
                                    </div>
                                </div>
                            </div>
                        </span>
                ...
                <section class="col-md-12 card-wrapper pull-right">
