...
<body>
    <table cellpadding="0" cellspacing="0" width="100%" style="border:1;border-collapse:collapse;border-spacing:0;font-size:20px;color:#333;font-family:Arial, Helvetica, sans-serif">
        <tr>
            <td>
                <h2 style="font-size:28px;color:#788db4;text-align:center;">{{$data['first_name'] }} {{ $data['last_name']}}</h2>
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#788db4">Summary</h2>
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#788db4">Skills</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#788db4">Work History</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#788db4">Education</h2>
                <div style="padding: 0 20px">
        ...
        <tr>
            <td>
                <h2 style="text-align: left;font-size:28px;color:#788db4">Reference</h2>
                <div style="padding: 0 20px">
