    ...
    <div class="container-fluid">
        <div class="main clearfix">
            <div class="row clearfix">
                                    ...
                                    <ul class="list-unstyled clear-margin">
                                        ...
                                        <li class="card card-nested clearfix">
                                            <div class="content">
                                                ...
                                                <p class="text-muted"><small><span class="space-right">{{$each['start_date']}} to @if(!empty($each['end_date'])) {{$each['end_date']}} @else {{"Current"}} @endif</span></small></p>
                ...
                <section class="col-md-3 card-wrapper profile-card-wrapper affix float-left">
